<!--
title: 'AWS Serverless REST API with DynamoDB store example in Python with Idempotence Guaranteed'
...
AWS DynamoDB provides an [idempotent transactional write API](https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_TransactWriteItems.html), which writes todos for only once and does nothing on retry.
